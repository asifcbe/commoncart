...
| `frontend/src/utils/bill.js` | Bill/receipt HTML + `carriedSettlementOf()`; `printBillHTML`/`printDocumentHTML` print via a hidden same-page iframe, **not** `window.open` |
...
## Completed Features (as of July 2026)
